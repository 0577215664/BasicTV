...
typedef std::vector<std::tuple<id_t_, id_t_, void*> > net_http_file_driver_state_socket_service_bind_t;
...
#define NET_HTTP_FILE_DRIVER_MEDIUM_INIT(medium) net_http_file_driver_state_t *net_http_file_driver_##medium##_init(uint8_t medium, id_t_ service_id)
#define NET_HTTP_FILE_DRIVER_MEDIUM_CLOSE(medium) void net_http_file_driver_##medium##_close(net_http_file_driver_state_t *file_driver_state_ptr)
#define NET_HTTP_FILE_DRIVER_MEDIUM_PULL(medium) std::vector<uint8_t> net_http_file_driver_##medium##_pull(net_http_file_driver_state_t *file_driver_state_ptr)
