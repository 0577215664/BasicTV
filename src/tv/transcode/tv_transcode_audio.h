...
extern tv_transcode_state_encode_codec_t audio_encode_codec_lookup(uint8_t format);
extern tv_transcode_state_decode_codec_t audio_decode_codec_lookup(uint8_t format);
